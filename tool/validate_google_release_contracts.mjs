...
assertContract(
  /ca-app-pub-5274007212820203~4912255757/.test(manifest),
...
const rewardedId = 'ca-app-pub-5274007212820203/3342599731';
const rewardedInterstitialId = 'ca-app-pub-5274007212820203/2197039025';
...
const adUnitsStart = monetization.indexOf('class HomePilotAdUnits');
const adUnitsEnd = monetization.indexOf('class HomePilotAdsService');
assertContract(
  adUnitsStart >= 0 && adUnitsEnd > adUnitsStart,
  'The HomePilot ad-unit mapping could not be isolated.',
);
