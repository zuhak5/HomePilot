...
void main() {
  ...
  testWidgets('first Flutter frame contains the process splash', (
    ...
    await tester.pumpWidget(
      HomePilotProcessSplash(child: _BranchHost(branch: branch)),
    );

    expect(find.byType(HomePilotProcessSplash), findsOneWidget);
    expect(find.byType(HomePilotSplashOverlay), findsOneWidget);
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      expect(
        find.bySemanticsLabel(arabic.startupStartingHomePilot),
        findsOneWidget,
      );
