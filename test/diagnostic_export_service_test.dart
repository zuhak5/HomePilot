...
import 'package:homepilot/src/core/services/diagnostic_export_service.dart';
...
void main() {
  ...
  test('expired temporary diagnostic bundles are deleted', () async {
    final directory = Directory(
      '${temporary.path}${Platform.pathSeparator}homepilot-diagnostics',
    );
