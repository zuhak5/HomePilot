...
import 'package:homepilot/src/features/auth/data/local_account_data_cleaner.dart';
...
void main() {
  ...
  test(
    ...
    () async {
      ...
      await _writePrivateFile(documents, 'backups/homepilot-manual.zip');
      await _writePrivateFile(documents, 'homepilot-backup-state.json');
      ...
      expect(
        await File(
          p.join(documents.path, 'homepilot-backup-state.json'),
        ).exists(),
        isFalse,
      );
