...
import 'package:homepilot/src/core/services/health_score_calculator.dart';
import 'package:homepilot/src/core/services/notification_service.dart';
import 'package:homepilot/src/core/services/recurrence_engine.dart';
...
void main() {
  ...
  test('notification scheduling preserves instants across a DST zone', () {
    ...
    expect(
      notificationDateInConfiguredTimezone(
        beforeTransition,
  ...
  group('HomePilotRecurrenceEngine', () {
    const engine = HomePilotRecurrenceEngine();
