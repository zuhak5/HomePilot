...
import 'package:homepilot/src/core/domain/feature_models.dart';
import 'package:homepilot/src/core/domain/models.dart';
import 'package:homepilot/src/core/domain/task_selectors.dart';
import 'package:homepilot/src/core/domain/text_formatters.dart';
import 'package:homepilot/src/core/services/feature_selectors.dart';
import 'package:homepilot/src/core/utils/date_utils.dart' as hk_dates;
...
void main() {
  ...
  group('copy helpers', () {
    test('pluralizes and formats recurrence naturally', () {
      expect(pluralize(1, 'task'), '1 task');
      expect(pluralize(2, 'task'), '2 tasks');
      expect(
  ...
  group('fresh install schema', () {
    test('new databases start empty with seeded categories', () async {
      final file = await File(
        '${Directory.systemTemp.path}/homepilot_schema_${DateTime.now().microsecondsSinceEpoch}.sqlite',
      ).create();
