...
void main() {
  ...
  test('Android launcher and splash PNGs have exact density dimensions', () {
    ...
    expect(_pngSize('assets/brand/homepilot-app-icon.png'), (
      width: 604,
      height: 604,
    ));
    expect(_pngSize('assets/splash/homepilot_splash_icon_3d.png'), (
      width: 432,
      height: 432,
    ));
    expect(_pngSize('assets/splash/homepilot_splash_android12.png'), (
      width: 1152,
      height: 1152,
    ));
    expect(
  ...
  test('launcher artwork fits circular masks and splash safe areas', () async {
    ...
    final foregroundInset = (foreground.width * 0.18).round();
    ...
    expect(await _cornerAlpha('assets/splash/homepilot_splash_icon_3d.png'), 0);
    expect(
      await _cornerAlpha('assets/splash/homepilot_splash_android12.png'),
      0,
    );
    expect(
