...
import 'package:homepilot/src/core/observability/sentry_logger_bridge.dart';
import 'package:homepilot/src/core/observability/sentry_tracing.dart';
...
void main() {
  ...
  test('reportable duplicate failures create one issue', () async {
    ...
    expect(fingerprints, ['homepilot::sync_run_failed::reportable']);
  });
