...
import 'package:homepilot/src/core/observability/sentry_scope.dart';
...
void main() {
  const config = ObservabilityConfig(
    ...
    dsn: 'redacted',
    environment: 'prod',
    release: 'com.homepilot.app@1.3.4+19',
    dist: '19',
    appVersion: '1.3.4',
  ...
  test(
    ...
    () async {
      ...
      await applyHomePilotBaseScope(scope, config, runId: 'run-test');
