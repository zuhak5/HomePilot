...
**Baseline audited by all four source plans:** `075cd6ff5c36bb9c05b03f10a20598310ecf000d`  
**Baseline application version:** `1.4.8+34`  
**Master-plan synthesis date:** 2026-08-08  
**Plan type:** implementation-ready, repository-grounded AI coding-agent execution specification  
**Primary objective:** implement **all actionable requirements** from the four embedded source plans as one coherent remediation program, while preserving HomePilot's security, offline-first behavior, privacy boundaries, routing, localization, release safety, and existing correct behavior.
...
Use the highest available reasoning/effort mode corresponding to the operator-selected **Gemini 3.6 Flash / High** profile.
...
At synthesis time, GitHub `main` still points to:

`075cd6ff5c36bb9c05b03f10a20598310ecf000d`

That is the exact baseline referenced by all four source plans. Therefore their code-level findings are not historical drift; they describe the current audited `main`.
...
If `main` has moved, perform a scoped drift audit before editing and preserve newer unrelated behavior.
...
This section is the normalized review. The original plans remain authoritative detail appendices when they do not conflict with this master section.
...
You understand which source-plan assumptions still match current `main`.
...
# 16. ORIGINAL SOURCE PLANS — VERBATIM APPENDICES
