...
HomePilot maintains both user-domain data and operational metadata. The Drift schema and Supabase migrations are authoritative; this document describes conceptual groups and review obligations rather than duplicating every column.
