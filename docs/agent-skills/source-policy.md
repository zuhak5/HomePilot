...
No external skill may be copied directly into HomePilot's active skill directory without review.

## Source classifications

### Official exact match

Published by the relevant technology maintainer and compatible with HomePilot's framework and SDK generation. It may be vendored after license, command, script, and trigger review.
...
3. More-specific HomePilot skills.
