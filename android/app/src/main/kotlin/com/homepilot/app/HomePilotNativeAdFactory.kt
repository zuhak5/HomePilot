...
class HomePilotNativeAdFactory(
    ...
    override fun createNativeAd(
        ...
        val adBadge = view.findViewById<TextView>(R.id.homepilot_ad_badge)
        val sponsored = view.findViewById<TextView>(R.id.homepilot_ad_sponsored)
    ...
    private data class NativeAdPalette(
        ...
        companion object {
            ...
            fun fromResources(context: Context): NativeAdPalette =
                NativeAdPalette(
                    backgroundColor = context.color(R.color.homepilot_ad_surface),
                    borderColor = context.color(R.color.homepilot_ad_border),
                    headlineColor = context.color(R.color.homepilot_ad_text_primary),
                    bodyColor = context.color(R.color.homepilot_ad_text_secondary),
                    advertiserColor = context.color(R.color.homepilot_ad_text_secondary),
                    sponsoredColor = context.color(R.color.homepilot_ad_text_secondary),
                    adBadgeBackgroundColor =
                        context.color(R.color.homepilot_ad_badge_background),
                    adBadgeTextColor = context.color(R.color.homepilot_ad_badge_text),
                    callToActionBackgroundColor =
                        context.color(R.color.homepilot_ad_cta_background),
                    callToActionTextColor = context.color(R.color.homepilot_ad_cta_text),
                )
        }
    }
}
