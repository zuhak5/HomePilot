-- Migration: Canonicalize Maintenance Completion Timestamps to Whole-Second Precision
begin;
...
begin
  ...
  if found then
    ...
    -- Canonical whole-second equality check for current plan due date vs expected due date
