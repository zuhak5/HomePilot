-- Migration: Harden complete_maintenance_task for client/server clock skew (CT-010)
begin;
...
begin
  ...
  -- CT-010: Canonicalize gross future record_completed_at instead of rejecting local completion
