...
class _WelcomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FullCanvasSystemUi(
      child: Theme(
        data: HomePilotTheme.light().copyWith(
    ...
    return Material(
      ...
      child: Semantics(
        ...
        child: SegmentedButton<AppLanguage>(
          key: const ValueKey('onboarding-language-selector'),
          showSelectedIcon: false,
          segments: [
            ButtonSegment(
              value: AppLanguage.en,
              label: const Text('English', textDirection: TextDirection.ltr),
            ),
            ButtonSegment(
              value: AppLanguage.ar,
              label: const Text('العربية', textDirection: TextDirection.rtl),
            ),
          ],
          selected: {language},
...
class _OnboardingLanguageSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      ...
      label: context.l10n.language,
      child: SizedBox(
        key: const ValueKey('onboarding-language-selector-hit-target'),
        width: 176,
        height: 48,
        child: Stack(
          alignment: Alignment.center,
          children: [
            ...
            Row(
              children: [
                _LanguageSegment(
                  key: const ValueKey('language-segment-en-hit-target'),
                  label: 'English',
                  textDirection: TextDirection.ltr,
                  selected: language == AppLanguage.en,
                ...
                _LanguageSegment(
                  key: const ValueKey('language-segment-ar-hit-target'),
                  label: 'العربية',
                  textDirection: TextDirection.rtl,
                  selected: language == AppLanguage.ar,
                  onTap: onChanged == null
                      ? null
                      : () => onChanged!(AppLanguage.ar),
                ),
              ],
            ),
          ],
...
class _LanguageSegmentVisual extends StatelessWidget {
  const _LanguageSegmentVisual({
    required this.label,
  ...
  Widget build(BuildContext context) {
    final scheme = Theme.of(context).colorScheme;
    final foreground = selected ? HkColors.appPrimary : scheme.onSurfaceVariant;
