...
TracesSamplerCallback homePilotTracesSampler(ObservabilityConfig config) {
...
const homePilotTraceOperations = <String>{
  'app.start',
  'app.sentry_init',
  'app.first_frame',
...
String normalizeTraceOperation(String operation) {
  ...
  return homePilotTraceOperations.contains(normalized)
      ? normalized
      : 'app.operation';
}

Future<T> traceHomePilotOperation<T>(
  String operation,
