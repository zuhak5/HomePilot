...
Future<bool> startRestoreForegroundService({required String localeCode}) async {
  ...
  if (await FlutterForegroundTask.isRunningService) {
    ...
    result = await FlutterForegroundTask.startService(
      ...
      callback: homePilotRestoreForegroundCallback,
    );
  }
...
void homePilotRestoreForegroundCallback() {
...
String _stageLabel(AppLocalizations l10n, InitialHydrationStage stage) =>
    switch (stage) {
      ...
      InitialHydrationStage.finalizing => l10n.finalizingHomePilot,
    };
