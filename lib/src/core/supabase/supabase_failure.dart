  ...
  static SupabaseFailure from(Object error) {
    ...
    if (error is PostgrestException) {
      ...
      if (error.code == '42P01' ||
        ...
        return const SupabaseFailure(
          ...
          message:
              'This HomePilot build is not compatible with the cloud sync '
    ...
    if (isLocalDatabaseBusyError(error)) {
      return const SupabaseFailure(
        ...
        message:
            'HomePilot is finishing another local database operation. '
    ...
    if (looksLikeRawDatabaseError(error)) {
      return const SupabaseFailure(
        kind: SupabaseFailureKind.unknown,
        message:
            'HomePilot could not finish a local database operation. '
