...
/// HomePilot treats maintenance due dates as local calendar-day obligations.
...
TaskBucketStatus getTaskBucketStatusFromDueDate(
  ...
  final nextSevenEnd = today.add(const Duration(days: 7));
...
ItemTaskStatusSummary itemTaskStatusFor(
  ...
  return ItemTaskStatusSummary(
    ...
    label: 'On track',
    count: itemTasks.length,
    priority: _highestPriority(itemTasks),
    nextDueAt: itemTasks.first.plan.nextDueDate,
  );
}
