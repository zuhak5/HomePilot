...
const double kHomePilotFabWidth = 136;
const double kHomePilotFabHeight = 48;
const double kHomePilotFabLabelMaxWidth = 76;
const double kHomePilotBottomNavVisualHeight = 74;
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      ...
      child: Tooltip(
        ...
        child: SizedBox(
          width: width,
          height: kHomePilotHeaderActionHeight,
          child: Material(
...
class HomePilotFloatingActionButton extends StatefulWidget {
  const HomePilotFloatingActionButton({
    required this.icon,
    required this.label,
    required this.onPressed,
    this.tooltip,
  ...
  @override
  State<HomePilotFloatingActionButton> createState() =>
      _HomePilotFloatingActionButtonState();
}

class _HomePilotFloatingActionButtonState
    extends State<HomePilotFloatingActionButton>
    with SingleTickerProviderStateMixin {
      ...
      child: Padding(
        ...
        child: ClipRRect(
          ...
          child: BackdropFilter(
            ...
            child: DecoratedBox(
              decoration: BoxDecoration(
                color: scheme.surfaceContainerLowest.withValues(alpha: 0.91),
                borderRadius: BorderRadius.circular(HkRadii.xxl),
                border: Border.all(
